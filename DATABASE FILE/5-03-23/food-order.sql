...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2023 at 10:17 PM
...
(11, 'cust1', 'cust1', 'cust1@gmail.com', 'cust1', 18, 'cust1@gmail.com', 'cust1@gmail.com', 'cust1@gmail.com', 'cust1@gmail.com', '', '', '', 0, '', '', '', '', '', '', '', 0, '', '', '', '', '10b8e822d03fb4fd946188e852a4c3e2', 'e187ac4ffa5edc952fda7869be7a8841', '2023-05-02 12:14:45', '1683054885', 1);
...
(1, 'Main Dish Non-Vegetarian Rice-Include', 1),
(2, 'Pizza', 1);
...
(1, 'Butter Masala (Lamb/Goat)', '', '18.99', 55, 'product-featured-1.jpg', '<br><span style=\"color: rgb(31, 35, 40); font-family: ui-monospace, SFMono-Regular, \"SF Mono\", Menlo, Consolas, \"Liberation Mono\", monospace; font-size: 12px; white-space: pre;\">TENDER BONELESS LAMB/GOAT MARINATED </span><span style=\"color: rgb(31, 35, 40); font-family: ui-monospace, SFMono-Regular, \"SF Mono\", Menlo, Consolas, \"Liberation Mono\", monospace; font-size: 12px; white-space: pre;\">WITH VARIOUS SPICES, COOKED WITH HERB</span><br>', '', '', '', '', 10, 1, 1, 1),
(2, 'HALAL DONAIR FEAST PIZZA', '', '', 0, 'product-featured-2.jpg', '<p><span style=\"color: rgb(31, 35, 40); font-family: ui-monospace, SFMono-Regular, &quot;SF Mono&quot;, Menlo, Consolas, &quot;Liberation Mono&quot;, monospace; font-size: 12px; white-space: pre;\">DONAIR SAUCE OR PIZZA SAUCE, ONION, GREEN </span><span style=\"color: rgb(31, 35, 40); font-family: ui-monospace, SFMono-Regular, &quot;SF Mono&quot;, Menlo, Consolas, &quot;Liberation Mono&quot;, monospace; font-size: 12px; white-space: pre;\">PEPPER, TOMATO, DONAIR CHICKEN OR BEEF</span><br></p>', '', '', '', '', 6, 1, 1, 2);
...
CREATE TABLE `tbl_product_size` (
  ...
  `p_id` int(11) NOT NULL,
  `so_price` varchar(10) NOT NULL,
  `sc_price` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `tbl_product_size` (`id`, `size_id`, `p_id`, `so_price`, `sc_price`) VALUES
(1, 1, 2, '22', '21'),
(2, 2, 2, '', ''),
(3, 3, 2, '', '');
...
(1, 'slider-1.jpg', 'Welcome to Famous Chicken', 'Shop Online for Latest Women Accessories', 'View Women Accessories', 'product-category.php?id=4&type=mid-category', 'Center'),
...
(1, 'Administrator', 'admin@mail.com', '7777777777', '10b8e822d03fb4fd946188e852a4c3e2', 'user-1.png', 'Super Admin', 'Active'),
...
--
ALTER TABLE `tbl_mid_category`
  MODIFY `mcat_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
