                            ...
                            <form action="" method="post">
                                ...
                                <div class="p-price">
                                    ...
                                    <span>
                                        ...
                                        // If product has sizes, retrieve price from tbl_product_size
                                        if ($hasSizes) {
                                            $statement = $pdo->prepare("SELECT * FROM tbl_product_size WHERE p_id = ? AND size_id = ?");
                                            $statement->execute(array($_REQUEST['id'], $row['size_id']));
                                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                            if (count($result) > 0) {
                                                $p_old_price = $result[0]['p_old_price'];
                                                $p_current_price = $result[0]['p_current_price'];
                                            }
                                        }
                                ...
                                <div class="p-quantity">
                                    ...
                                    <input type="number" class="input-text qty" step="1" min="1" name="p_qty" value="1" title="Qty" size="4" pattern="[0-9]*" inputmode="numeric">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation"><a href="#condition" aria-controls="condition" role="tab" data-toggle="tab">Calorie Information</a></li>
                ...
                <div class="product-carousel">
                    ...
                    <div class="product-carousel">
                        ...
                        foreach ($result as $row) {
                            ...
                            // Check if product has sizes
                            $statement2 = $pdo->prepare("SELECT * FROM tbl_product_size WHERE p_id=?");
                            $statement2->execute(array($row['p_id']));
                            $sizes = $statement2->fetchAll(PDO::FETCH_ASSOC);

                            if (count($sizes) > 0) {
                                $size = $sizes[0]; // Get first size
                                $current_price = $size['p_current_price'];
                                $old_price = $size['p_old_price'];
                            }
                        ?>
                            <div class="item">
                                <div class="thumb">
                                ...
                                <div class="text">
                                    ...
                                    <h4>
                                        ...
                                        <?php if ($old_price != '' && $old_price != '0') : ?>
                                            <del>
                                                <?php echo LANG_VALUE_1; ?><?php echo $old_price; ?>
                                            </del>
                                        <?php endif; ?>
                                    </h4>
